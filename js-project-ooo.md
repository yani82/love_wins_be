...
The application we will create during the project build series is a "Syllabus Sharing App (Volunteering Experience Sharing App" for independent study.
...
- [x] 8. Build your models: `rails g model Post title content`
  - Migrations
  - Model classes
  - Associations
